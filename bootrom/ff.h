...
FRESULT chk_mounted (const TCHAR **path, FATFS **rfs, BYTE chk_wp);
...
FRESULT f_opendir (FFDIR*, const TCHAR*);           /* Open an existing directory */
FRESULT f_readdir (FFDIR*, FILINFO*);               /* Read a directory item */
