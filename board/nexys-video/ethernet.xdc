...
set_input_delay -clock rgmii_rx_clk -max 4.60 [get_ports { rgmii_rd* rgmii_rx_ctl }]
set_input_delay -clock rgmii_rx_clk -min 3.40 [get_ports { rgmii_rd* rgmii_rx_ctl }]
set_input_delay -clock rgmii_rx_clk -max 4.60 [get_ports { rgmii_rd* rgmii_rx_ctl }] -clock_fall -add_delay
set_input_delay -clock rgmii_rx_clk -min 3.40 [get_ports { rgmii_rd* rgmii_rx_ctl }] -clock_fall -add_delay
...
# TX data delayed 2 ns relative to TX clock
