...
set_max_delay -from $main_clock -through [get_pins -hier Ethernet/async_resetn] -datapath_only 20.0
set_max_delay -from $eth_main_clock -through [get_pins -hier Ethernet/interrupt] -datapath_only 20.0
