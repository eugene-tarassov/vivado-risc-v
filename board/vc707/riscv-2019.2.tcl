...
proc create_hier_cell_EthernetVC707 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_EthernetVC707() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: ethernet_vc707_0, and set properties
  set block_name ethernet_vc707
  set block_cell_name ethernet_vc707_0
  if { [catch {set ethernet_vc707_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ethernet_vc707_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins sgmii] [get_bd_intf_pins gig_ethernet_pcs_pma_0/sgmii]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins sgmii_mgt_clk] [get_bd_intf_pins gig_ethernet_pcs_pma_0/gtrefclk_in]
  connect_bd_intf_net -intf_net Ethernet_TX_AXIS [get_bd_intf_pins TX_AXIS] [get_bd_intf_pins ethernet_vc707_0/TX_AXIS]
  connect_bd_intf_net -intf_net ethernet_vc707_0_GMII [get_bd_intf_pins ethernet_vc707_0/GMII] [get_bd_intf_pins gig_ethernet_pcs_pma_0/gmii_pcs_pma]
  connect_bd_intf_net -intf_net ethernet_vc707_0_RX_AXIS [get_bd_intf_pins RX_AXIS] [get_bd_intf_pins ethernet_vc707_0/RX_AXIS]

  # Create port connections
  connect_bd_net -net Ethernet_reset [get_bd_pins reset] [get_bd_pins ethernet_vc707_0/reset]
  connect_bd_net -net ethernet_vc707_0_upgraded_ipi_an_adv_config_vector [get_bd_pins ethernet_vc707_0/an_adv_config_vector] [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_vector]
  connect_bd_net -net ethernet_vc707_0_upgraded_ipi_an_restart_config [get_bd_pins ethernet_vc707_0/an_restart_config] [get_bd_pins gig_ethernet_pcs_pma_0/an_restart_config]
  connect_bd_net -net ethernet_vc707_0_upgraded_ipi_clock [get_bd_pins clock] [get_bd_pins ethernet_vc707_0/clock]
  connect_bd_net -net ethernet_vc707_0_upgraded_ipi_configuration_vector [get_bd_pins ethernet_vc707_0/configuration_vector] [get_bd_pins gig_ethernet_pcs_pma_0/configuration_vector]
  connect_bd_net -net ethernet_vc707_0_upgraded_ipi_signal_detect [get_bd_pins ethernet_vc707_0/signal_detect] [get_bd_pins gig_ethernet_pcs_pma_0/signal_detect]
  connect_bd_net -net ethernet_vc707_0_upgraded_ipi_speed_is_100 [get_bd_pins ethernet_vc707_0/speed_is_100] [get_bd_pins gig_ethernet_pcs_pma_0/speed_is_100]
  connect_bd_net -net ethernet_vc707_0_upgraded_ipi_speed_is_10_100 [get_bd_pins ethernet_vc707_0/speed_is_10_100] [get_bd_pins gig_ethernet_pcs_pma_0/speed_is_10_100]
  connect_bd_net -net gig_ethernet_pcs_pma_0_an_interrupt [get_bd_pins ethernet_vc707_0/an_interrupt] [get_bd_pins gig_ethernet_pcs_pma_0/an_interrupt]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_isolate [get_bd_pins ethernet_vc707_0/gmii_isolate] [get_bd_pins gig_ethernet_pcs_pma_0/gmii_isolate]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gt0_qplloutclk_out [get_bd_pins ethernet_vc707_0/gt0_qplloutclk_out] [get_bd_pins gig_ethernet_pcs_pma_0/gt0_qplloutclk_out]
  connect_bd_net -net gig_ethernet_pcs_pma_0_gt0_qplloutrefclk_out [get_bd_pins ethernet_vc707_0/gt0_qplloutrefclk_out] [get_bd_pins gig_ethernet_pcs_pma_0/gt0_qplloutrefclk_out]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_pma_reset_out [get_bd_pins ethernet_vc707_0/pma_reset_out] [get_bd_pins gig_ethernet_pcs_pma_0/pma_reset_out]
  connect_bd_net -net gig_ethernet_pcs_pma_0_sgmii_clk_en [get_bd_pins ethernet_vc707_0/sgmii_clk_en] [get_bd_pins gig_ethernet_pcs_pma_0/sgmii_clk_en]
  connect_bd_net -net gig_ethernet_pcs_pma_0_sgmii_clk_f [get_bd_pins ethernet_vc707_0/sgmii_clk_f] [get_bd_pins gig_ethernet_pcs_pma_0/sgmii_clk_f]
  connect_bd_net -net gig_ethernet_pcs_pma_0_sgmii_clk_r [get_bd_pins ethernet_vc707_0/sgmii_clk_r] [get_bd_pins gig_ethernet_pcs_pma_0/sgmii_clk_r]
  connect_bd_net -net gig_ethernet_pcs_pma_0_status_vector [get_bd_pins status_vector] [get_bd_pins ethernet_vc707_0/status_vector] [get_bd_pins gig_ethernet_pcs_pma_0/status_vector]
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out [get_bd_pins ethernet_vc707_0/userclk2_out] [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out]
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk_out [get_bd_pins ethernet_vc707_0/userclk_out] [get_bd_pins gig_ethernet_pcs_pma_0/userclk_out]
  ...
  connect_bd_net -net sys_reset_1 [get_bd_pins sys_reset] [get_bd_pins gig_ethernet_pcs_pma_0/reset]
...
proc create_hier_cell_IO { parentCell nameHier } {
  ...
  # Create instance: sdc_controller_0_axi_periph, and set properties
  set sdc_controller_0_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 sdc_controller_0_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
 ] $sdc_controller_0_axi_periph
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins sgmii] [get_bd_intf_pins EthernetVC707/sgmii]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins sgmii_mgt_clk] [get_bd_intf_pins EthernetVC707/sgmii_mgt_clk]
  ...
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins Ethernet/M_AXI] [get_bd_intf_pins sdc_controller_0_axi_periph/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins SD/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins Ethernet/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_pins rs232_uart] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net ethernet_vc707_0_RX_AXIS [get_bd_intf_pins Ethernet/RX_AXIS] [get_bd_intf_pins EthernetVC707/RX_AXIS]
  connect_bd_intf_net -intf_net sdc_controller_0_M_AXI [get_bd_intf_pins SD/M_AXI] [get_bd_intf_pins sdc_controller_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net sdc_controller_0_axi_periph_M00_AXI [get_bd_intf_pins M00_AXI] [get_bd_intf_pins sdc_controller_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net ethernet_0_clock [get_bd_pins Ethernet/clock] [get_bd_pins EthernetVC707/clock] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins sdc_controller_0_axi_periph/S01_ACLK]
  ...
  connect_bd_net -net sd_ref_clk_1 [get_bd_pins clock_100MHz] [get_bd_pins SD/clock] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins sdc_controller_0_axi_periph/S00_ACLK]
  ...
  connect_bd_net -net sys_reset_1 [get_bd_pins sys_reset] [get_bd_pins EthernetVC707/sys_reset]
...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  connect_bd_net -net clock_200MHz_1 [get_bd_pins clock_200MHz] [get_bd_pins mig_7series_0/sys_clk_i]
  ...
  connect_bd_net -net reset_1 [get_bd_pins sys_reset] [get_bd_pins mig_7series_0/sys_rst]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net sdc_controller_0_axi_periph_M00_AXI [get_bd_intf_pins IO/M00_AXI] [get_bd_intf_pins RocketChip/DMA_AXI4]
  ...
  connect_bd_net -net clk_wiz_clk_out2 [get_bd_pins IO/clock_100MHz] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net clock_200MHz_1 [get_bd_pins DDR/clock_200MHz] [get_bd_pins IO/clock_200MHz] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins DDR/sys_reset] [get_bd_pins IO/sys_reset] [get_bd_pins RocketChip/sys_reset] [get_bd_pins clk_wiz_0/reset]
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins DDR/aresetn] [get_bd_pins IO/ARESETN] [get_bd_pins RocketChip/aresetn]
  connect_bd_net -net sdc_controller_0_sdio_clk [get_bd_ports sdio_clk] [get_bd_pins IO/sdio_clk]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins sys_diff_clock_buf/IBUF_OUT]
