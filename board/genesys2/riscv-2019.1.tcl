...
# module references:
# $rocket_module_name, ethernet, sdc_controller, ethernet_genesys2, uart, synchronizer
...
proc write_mig_file_riscv_mig_7series_0_4 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>riscv_mig_7series_0_4</ModuleName>}
...
# End of write_mig_file_riscv_mig_7series_0_4()
...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  write_mig_file_riscv_mig_7series_0_4 $str_mig_file_path
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x60010000 [get_bd_addr_spaces RocketChip/IO_AXI4] [get_bd_addr_segs IO/UART/S_AXI_LITE/reg0] SEG_UART_reg0
