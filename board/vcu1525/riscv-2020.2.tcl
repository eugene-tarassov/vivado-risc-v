...
# module references:
# $rocket_module_name, synchronizer, uart
...
proc create_hier_cell_IO { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.pf0_pciebar2axibar_2 {0x0000000080000000} \
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In4] [get_bd_pins xlconcat_0/In5] [get_bd_pins xlconcat_0/In6] [get_bd_pins xlconcat_0/In7] [get_bd_pins xlconstant_0/dout]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net reset [get_bd_pins DDR/sys_reset] [get_bd_pins RocketChip/sys_reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins resetn_inv_0/Res]
